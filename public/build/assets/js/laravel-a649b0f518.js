(function () {
    ...
    function stickySidebar ($) {
        var $scotch = $('.scotch-panel-canvas');
        ...
        $window.on('scroll', function () { return scrolled = true; });
        ...
        var Position = {
            ...
            toStatus: function toStatus (status, callback) {
            ...
            staticallyPosition: function staticallyPosition () {
                this.toStatus(this.statuses.static, function () {
                    $sidebar.css({
                        position: 'static',
                        bottom: '',
                        top: '',
            ...
            affixToTop: function affixToTop () {
                this.toStatus(this.statuses.fixedToTop, function () {
                    $sidebar.css({
                        position: 'fixed',
                        bottom: '',
                        top: 0,
            ...
            affixToBottom: function affixToBottom () {
                this.toStatus(this.statuses.fixedToBottom, function () {
                    $sidebar.css({
                        position: 'fixed',
                        bottom: 0,
                        top: '',
            ...
            affixToFooter: function affixToFooter () {
                this.toStatus(this.statuses.fixedToFooter, function () {
                    $sidebar.css({
                        position: 'absolute',
                        bottom: footerHeight,
                        top: '',
            ...
            affixAbsolutely: function affixAbsolutely () {
                var this$1 = this;

                this.toStatus(this.statuses.absolute, function () {
                    $sidebar.css({
                        position: 'absolute',
                        top: this$1.getTopForAbsolutePosition(),
                        bottom: '',
                    });
                });
            },

            affixAbsolutelyToCurrentPosition: function affixAbsolutelyToCurrentPosition () {
                this.toStatus(this.statuses.absolute, function () {
                    $sidebar.css({
                        position: 'absolute',
                        top: position,
            ...
            getTopForAbsolutePosition: function getTopForAbsolutePosition () {
                return position + windowHeight - sidebarHeight;
            },

            atTopOfSidebar: function atTopOfSidebar () {
                return $sidebar.offset().top >= position;
            },

            atBottomOfSidebar: function atBottomOfSidebar () {
                return position > $sidebar.offset().top + sidebarHeight - windowHeight;
            },

            atHeader: function atHeader () {
                return position <= headerHeight;
            },

            atFooter: function atFooter () {
    ...
    function slideMenu ($) {
        var scotchPanel = $('#slide-menu').scotchPanel({
            ...
            afterPanelClose: function () { return $(document).trigger('scotch.closed'); },
